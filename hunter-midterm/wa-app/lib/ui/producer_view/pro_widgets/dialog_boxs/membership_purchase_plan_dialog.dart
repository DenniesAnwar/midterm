...
showGooglePurchaseMembershipPaymentDialog(BuildContext context, formKey) {
  return showDialog(
      context: context,
      builder: (context) {
        return const GooglePurchaseMembershipPaymentDialog();
      });
}

class GooglePurchaseMembershipPaymentDialog extends StatefulWidget {
  const GooglePurchaseMembershipPaymentDialog({Key? key}) : super(key: key);

  @override
  _GooglePurchaseMembershipPaymentDialogState createState() =>
      _GooglePurchaseMembershipPaymentDialogState();
}
// dialog used for purchasing the script using google payment card

class _GooglePurchaseMembershipPaymentDialogState
    extends State<GooglePurchaseMembershipPaymentDialog> {
  @override
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding:EdgeInsets.only(top: SizeConfig.heightMultiplier * 2.091, bottom: SizeConfig.heightMultiplier * 2.115),
                        child: Buttons.customPrimaryButton(
                            onPressed: () {},
                            borderRoundness: SizeConfig.heightMultiplier * 0.915,
                            fontSize: 16,
